...
export type MyQueryQuery = { __typename?: 'Query', categories: Array<{ __typename?: 'Category', id: string, slug: string, title: string, product: Array<{ __typename?: 'Product', id: string, name: string, availability: boolean, price: number, productDescription: string, slug?: string | null, productPhoto: Array<{ __typename?: 'Asset', id: string, url: string }> }> }> };
