...
export type MyQueryQuery = { __typename?: 'Query', products: Array<{ __typename?: 'Product', id: string, name: string, price: number, availability: boolean, slug?: string | null, productDescription: string, category?: { __typename?: 'Category', id: string, slug: string, title: string } | null, productPhoto: Array<{ __typename?: 'Asset', id: string, url: string }> }> };
